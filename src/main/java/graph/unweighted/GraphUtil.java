...
//    public static AllVo traverse(final GraphMeta graphMeta, final GraphFunc<SingleStartParam, AllTemp, SingleVo> maxConnectedChildGraphTraverse) {
    public static void allTraverse(final GraphMeta graphMeta, final GraphFunc<SingleStartParam, AllTemp, SingleVo, AllVo> maxConnectedChildGraphTraverse, SingleVo singleVo, AllVo allVo) {
