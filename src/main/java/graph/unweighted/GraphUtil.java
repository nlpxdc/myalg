...
//    public static AllVo traverse(final GraphMeta graphMeta, final GraphFunc<SingleStartParam, AllTemp, SingleVo> maxConnectedChildGraphTraverse) {
    public static void allTraverse(final GraphMeta graphMeta, final GraphFunc<SingleStartParam, SingleTemp, AllTemp, SingleVo, AllVo> maxConnectedChildGraphTraverse, SingleVo singleVo, AllVo allVo) {
...
//                SingleVo singleVo = new SingleVo();
                maxConnectedChildGraphTraverse.singleTraverse(singleStartParam, singleTemp, allTemp, singleVo, allVo);
