...
//    }
    ...
    public static int traverse(final int n, BiConsumer<Integer, TraverseTemp> singleConnectedTraverse) {
        //初始化临时数组，记录访问状态
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (firstUnVisited != null) {
                ...
                singleConnectedTraverse.accept(firstUnVisited, traverseTemp);
                System.out.println();
            } else {
                break;
            }
