package structure.logic.ve.linear.common;
...
//        structure.logic.list.sequence.MyLinkList myLinkList = new structure.logic.list.sequence.MyLinkList();
//        myLinkList.addEl(new structure.logic.list.sequence.MyLinkNode(4));
//        myLinkList.addEl(new structure.logic.list.sequence.MyLinkNode(2));
//        structure.logic.list.sequence.MyLinkNode myLinkNode = new structure.logic.list.sequence.MyLinkNode(17);
...
////        new int[]{0, 2}
//        int[] idxList = {2, 0};
//        structure.logic.list.sequence.MyLinkUtil.bubbleSort(idxList);
//
//        structure.logic.list.sequence.MyLinkNode[] myLinkNodes = myLinkList.batchGetByIdxList(idxList);
//
//        myLinkList.traverse();
...
//        structure.logic.list.sequence.MyLinkList downList = new structure.logic.list.sequence.MyLinkList();
//        downList.addEl(new structure.logic.list.sequence.MyLinkNode(2));
//        downList.addEl(new structure.logic.list.sequence.MyLinkNode(4));
//        downList.addEl(new structure.logic.list.sequence.MyLinkNode(6));
//        downList.addEl(new structure.logic.list.sequence.MyLinkNode(7));
//        downList.addEl(new structure.logic.list.sequence.MyLinkNode(7));
//        downList.addEl(new structure.logic.list.sequence.MyLinkNode(8));

//        structure.logic.list.sequence.MyLinkList myLinkList = structure.logic.list.sequence.MyLinkUtil.mergeSort(upList, downList);
//        myLinkList.traverse();
    }
}
...
//            int idx = idxList[i];
//            structure.logic.list.sequence.MyLinkNode node = getByIdx(idx);
//            ret[i] = node;
//        }
...
//        //获取idx前一个位置
//        structure.logic.list.sequence.MyLinkNode beforeIdxNode = getByIdx(idx - 1);
//        if (beforeIdxNode == null) {
//            throw new RuntimeException("idx前置节点为null");
//        }
//        structure.logic.list.sequence.MyLinkNode afterIdxNode = getByIdx(idx + 1);
//        beforeIdxNode.next = afterIdxNode;
    ...
    //todo 有序链表插入添加一个key 前后首尾双指针，单个迭代查找比较也可以，因为有序唯一，实现更复杂些，因为只能向前遍历，不能回头，所以会多一遍遍历，有更多边界
    //前一遍遍历相当于收集必要的数据，第二遍才是真正处理，但是双链表就可以直接处理遍历一次即可
