...
//        structure.logic.list.sequence.MyArrList myArrList = new structure.logic.list.sequence.MyArrList();
//        myArrList.addEl(new structure.logic.list.sequence.MyArrNode(5));
//        myArrList.addEl(new structure.logic.list.sequence.MyArrNode(3));
//        myArrList.addEl(new structure.logic.list.sequence.MyArrNode(18));
//
//        myArrList.traverse();
//
//        structure.logic.list.sequence.MyArrNode[] myArrNodes = myArrList.batchGetByIdxList(new int[]{0, 2});
//        myArrList.traverse();
