...
import structure.logic.vertexedge.relate.graph.common.unweighted.*;

import java.util.*;

class ChainForwardStarGraphAppV3 {
    public static void main(String[] args) {
        ChainForwardStarGraphV3 graph = new ChainForwardStarGraphV3(9);
...
class ChainForwardStarGraphV3 extends GraphMeta {
    int outArcCnt;
    final int[] vertexOutArcsHeadIdxAry;
//    OutArc[] outArcAry;
    final int[] toAry;
    final int[] nextIdxAry;

    public ChainForwardStarGraphV3(int n) {
        this.n = n;
...
//            OutArc currOutArc = outArcAry[vOutArcsHeadIdx];
            ...
            for ( int currIdx = vOutArcsHeadIdx;
                  currIdx != -1;
                  currIdx = nextIdxAry[currIdx]) {

                Integer adjaU = toAry[currIdx];
